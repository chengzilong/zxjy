...
public class Pojo1080110  extends Pojo_BMXX implements Serializable {
	...
	/**The value of the simple 推荐教师 property.*/
	private String TJJS;

	/**
	* Simple constructor of Abstract Pojo1080110 instances.
	*/
	public Pojo1080110(){
	}
	...
	*/
	...
	/**
	*Return the value of the 推荐教师 column.
	*
	*@return java.lang.String
	*/
	...
	*/
	...
	/**
	*Set the value of the 推荐教师 column.
	*
	*@param String TJJS
	*/
	public void setTJJS(String TJJS){
		this.TJJS=TJJS;
	}
}