...
public class Service1040160 extends BaseService {
	...
	public Pojo1040161 getRCSDListByID(Pojo1040161 beanIn) throws Exception {
		Pojo1040161 result = null;
		...
		try {
			...
			ResultSetHandler<Pojo1040161> rs = new BeanHandler<Pojo1040161>(
					Pojo1040161.class);
