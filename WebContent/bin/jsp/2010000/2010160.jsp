...
$(document).ready(function(){
   var cols = [
       ...
       { title:'提问内容', name:'WTXX_TWNR' ,width:350, sortable:true, align:'center',lockDisplay: true },
       ...
       { title:'悬赏积分', name:'WTXX_TWJF' ,width:80, sortable:true, align:'center',lockDisplay: true },
   ...
   mmg = $('.mmg').mmGrid({
        ...
        ,method: 'post'
        ,params:{CMD : "<%=Servlet2010160.CMD_SELECT%>"}
        ,remoteSort:true
        ,sortName: 'WTXX_WTID'
        ,sortStatus: 'ASC'
        ,root: 'items'
   ...
   mmg.on('cellSelected', function(e, item, rowIndex, colIndex){
	  var arrList = mmg.row(rowIndex);
        ...
        if($(e.target).is('.img-info')){
	    	...
	    	window.location.href='<%=basePath%>/bin/jsp/2010000/2010161.jsp?wtid=' + item.WTXX_WTID+'&twr='+item.TWR+'&twnr='+item.WTXX_TWNR;
