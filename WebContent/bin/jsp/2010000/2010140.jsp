<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com.xsjy.servlet.servlet2010000.Servlet2010140"%> 
<%
...
$(document).ready(function(){
   var cols = [
       ...
       { title:'评价内容', name:'PJXX_PJNR' ,width:600, sortable:true, align:'center',lockDisplay: true  },
       { title:'评价积分', name:'PJXX_PJJF' ,width:60, sortable:true, align:'center',lockDisplay: true  },
   ...
   mmg = $('.mmg').mmGrid({
         height: intheight
        ,cols: cols
        ,url: '<%=basePath%>/Servlet2010140'
        ,method: 'post'
        ,params:{CMD : "<%=Servlet2010140.CMD_SELECT%>"}
        ,remoteSort:true
        ,sortName: 'PJXX_PJID'
        ,sortStatus: 'ASC'
        ,root: 'items'
	...
	<fieldset id = "selectRegion">
		...
		<table>
			<tr>
				...
				<td><input id="txtSelJSXM" name="评价人" maxlength="20" /></td>
