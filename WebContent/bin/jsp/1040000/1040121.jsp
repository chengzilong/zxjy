...
$(document).ready(function(){
   ...
   mmg = $('.mmg').mmGrid({
        ...
        ,method: 'post'
        ,params:{CMD : "<%=Servlet1040120.CMD_SELECT_COURSE%>"}
        ,remoteSort:true
        ,sortName: 'KCFY_FYID'
        ,sortStatus: 'ASC'
        ,root: 'items'
...
//查询bean
function makeBeanInSearch(strBCID,strKCMC,strKCLX,strSKSD,strJS){
	this.BCID = strBCID;
	...
	<fieldset id = "editRegion">
		...
		<table id="detailCanvas" class="eTable6">
			<tr>
				...
				<td colspan="2"><input id="txtEditBcmc" name="班次名称" maxlength="20" /></td>
