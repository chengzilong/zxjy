		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				mmgClass = $('.mmgClass').mmGrid({
					...
					,method: 'post'
					,params:{CMD : "<%=Servlet1040140.CMD_SELECT_CLASS%>"}
					,remoteSort:true
					,sortName: 'BCXX_BCID'
					,sortStatus: 'ASC'
					,root: 'items'
				...
				mmgStu = $('.mmgStu').mmGrid({
					...
					,url: '<%=basePath%>/Servlet1040140'
					,method: 'post'
					,params:{CMD : "<%=Servlet1040140.CMD_SELECT_STUDENT%>"}
					,remoteSort:true
					,sortName: 'XSXX_XSID'
					,sortStatus: 'ASC'
					,root: 'items'
			...
			function btn_Relation() {
				...
				iframeLayerOpen('<%=basePath%>/bin/jsp/1040000/1040141.jsp');
			}
			//取消分班操作
			function cancelRelation() {
				...
				$.ajax({
					...
					url: "<%=basePath%>/Servlet1040140",
					data: {
						CMD		: "<%=Servlet1040140.CMD_CANCEL_RELATION%>",
						BCID			: bcId,
						STUIDS		: stuIds
					},
