<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com.xsjy.servlet.servlet1070000.Servlet1070140"%> 
<%
...
$(document).ready(function(){
   var cols = [
       ...
       { title:'评价内容', name:'PJXX_PJNR' ,width:400, sortable:true, align:'center',lockDisplay: true  },
       { title:'评价积分', name:'PJXX_PJJF' ,width:80, sortable:true, align:'center',lockDisplay: true  },
       { title:'评价时间', name:'PJXX_PJSJ' ,width:100, sortable:true, align:'center',lockDisplay: true  }
   ];
   ...
   mmg = $('.mmg').mmGrid({
         height: intheight
        ,cols: cols
        ,url: '<%=basePath%>/Servlet1070140'
        ,method: 'post'
        ,params:{CMD : "<%=Servlet1070140.CMD_SELECT%>"}
        ,remoteSort:true
        ,sortName: 'PJXX_PJID'
        ,sortStatus: 'ASC'
        ,root: 'items'
