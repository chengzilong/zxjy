<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com.xsjy.servlet.servlet3030000.Servlet3030130"%>     
<%
...
var intWidth="80px"; //单元格宽度
var intHeight="38px";//行高
var intHeightLx="28px";//行高
var txtYear = '';
var txtMonth = '';
...
$(document).ready(function(){
	...
	strBCRC_BCRCID=inputObj.BCRC_BCRCID;
...
function getDBData(){
	...
	$.ajax({
		...
		type      : "post",
		dataType  : "json",
		url: "<%=basePath%>/Servlet3030130",
		data: {
			CMD    : "<%=Servlet3030130.CMD_MUTI_SELECT%>",
...
function saveData(){
	...
	$.ajax({
		...
		url: "<%=basePath%>/Servlet3030130",
		data: {
			CMD    : "<%=Servlet3030130.CMD_MUTI_UPDATE%>",
...
function tableLoad_Department(tbControl1,Year,Month){
	...
	cellAll.innerHTML = "班次("+strBCRC_BCMC + ")课程安排---" + Year+"年"+Month+"月";		
	cellAll.colSpan = 7; 
	...
	//cellAll6.style.color=fontColor;
	//cellAll7.style.color=fontColor;
	//cellAll1.style.borderBottom="1px";
	...
	//rowAll_1.className="table_tr";
	//rowAll_1.style.borderBottom="1px";
	//bodyを追加
