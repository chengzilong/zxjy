...
<script type="text/javascript">
	...
	$(document).ready(function(){
	   var cols = [
	       ...
	       { title:'课程名称', name:'KCMC' ,width:80, sortable:true, align:'center',lockDisplay: false  },
	   ...
	   mmg = $('.mmg').mmGrid({
	        ...
	        ,method: 'post'
	        ,params:{CMD : "<%=Servlet3030130.CMD_SELECT%>"}
	        ,remoteSort:true
	   ...
	   mmg.on('cellSelected', function(e, item, rowIndex, colIndex){
			...
			if($(e.target).is('.btn-info')){
				...
				iframeLayerOpenown('<%=basePath%>/bin/jsp/3030000/3030131.jsp');
			}
	   });
