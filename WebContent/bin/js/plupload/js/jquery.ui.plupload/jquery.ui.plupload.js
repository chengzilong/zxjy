(function(f, a, c, g, e) {
    ...
    function d(i) {
        i.html('<div class="plupload_wrapper"><div class="ui-widget-content plupload_container"><div class="plupload"><div class="ui-state-default ui-widget-header plupload_header"><div class="plupload_header_content"><div class="plupload_header_title">' 
        		+ b("选择文件") + '</div><div class="plupload_header_text">' + b("添加一个文件到下载队列，然后点击开始按钮.") 
        		...
        		+ b("文件名") + '</td><td class="plupload_cell plupload_file_status">' 
        		+ b("状态") + '</td><td class="plupload_cell plupload_file_size">' 
        		+ b("大小") + '</td><td class="plupload_cell plupload_file_action">&nbsp;</td></tr></table><div class="plupload_scroll"><table class="plupload_filelist_content"></table></div><table class="plupload_filelist"><tr class="ui-widget-header ui-widget-content plupload_filelist_footer"><td class="plupload_cell plupload_file_name"><div class="plupload_buttons"><!-- Visible --><a class="plupload_button plupload_add">' 
        		+ b("添加文件") + '</a>&nbsp;<a class="plupload_button plupload_clear">'
        		+ b("清空") + '</a>&nbsp;<a class="plupload_button plupload_start">'
        		+ b("开始上传") + '</a>&nbsp;<a class="plupload_button plupload_stop plupload_hidden">' 
        		+ b("停止上传") + '</a>&nbsp;</div><div class="plupload_started plupload_hidden"><!-- Hidden --><div class="plupload_progress plupload_right"><div class="plupload_progress_container"></div></div><div class="plupload_cell plupload_upload_status"></div><div class="plupload_clearer">&nbsp;</div></div></td><td class="plupload_file_status"><span class="plupload_total_status">0%</span></td><td class="plupload_file_size"><span class="plupload_total_file_size">0 kb</span></td><td class="plupload_file_action"></td></tr></table></div></div></div><input class="plupload_count" value="0" type="hidden"></div>')
    }
    g.widget("ui.plupload", {
        ...
        _create: function() {
            ...
            this.clear_button = g(".plupload_clear", this.container).attr("id", "btn_clear");//ljg
            ...
            function(l, m) {
                ...
                i.clear_button.click(function(n) {
                    if (!g(this).button("option", "disabled")) {
                        i.clear();
                    }
                    n.preventDefault();
                ...
                if (n) {
                    ...
                    if (m) {
                        ...
                        case c.FILE_SIZE_ERROR:
                            m = b("File: %f, size: %s, max file size: %m").replace(/%([fsm])/g,
                            function(r, q) {
                                switch (q) {
                                case "f":
                                    return n.name;
                        ...
                        case c.IMAGE_DIMENSIONS_ERROR:
                            m = c.translate("Resoultion out of boundaries! <b>%s</b> runtime supports images only up to %wx%hpx.").replace(/%([swh])/g,
                            function(r, q) {
                                switch (q) {
                                case "s":
                                    return l.runtime;
        ...
        clear: function() {
        	var i,tempP;
        	for(i=this.uploader.files.length-1;i>=0;i--){
        		tempP=this.uploader.files[i];
        		g("#" + tempP.id).remove();
                this.uploader.removeFile(tempP);
        	}
        ...
        _updateFileList: function() {
            ...
            if (j.total.queued === 0) {
                g(".ui-button-text", k.browse_button).html(b("添加文件"))
            } else {
                g(".ui-button-text", k.browse_button).html(b("%d 个文件已选择.").replace("%d", j.total.queued))
            }
        ...
        _enableRenaming: function() {
            var i = this;
            this.filelist.on("click", ".plupload_delete .plupload_file_name span",
            function(o) {
                var m = g(o.target),
                k,
                n,
        ...
        _enableSortingList: function() {
            ...
            g("tbody", this.filelist).sortable({
                ...
                stop: function(p, o) {
                    var l, n, k, m = [];
                    g.each(g(this).sortable("toArray"),
                    function(q, r) {
        ...
        destroy: function() {
            ...
            if (g.ui.button) {
                g(".plupload_add, .plupload_start, .plupload_stop, .plupload_clear", this.container).button("destroy")
            }
            if (g.ui.progressbar) {
